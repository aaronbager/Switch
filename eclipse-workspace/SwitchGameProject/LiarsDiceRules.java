...
int activeValue = 0;
int activenumDice = 0;
public LiarsDiceRules(){
	
}
/*This method is invoked at the start of each round to change the hands of all players
 * 
 */
...
//	int value = s.nextInt(); 
	if (newValue>activeValue || numDice>activenumDice && newValue<=6){
...
public void compTurn(Player p){
	...
	for (int i = 0; i<hand.size();i++){
		...
		// if the computer has the same amount of dice or more than the active value then place a new bid
	if(count >= activenumDice){
